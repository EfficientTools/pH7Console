use crate::{AppState, ai::AIResponse, terminal::CommandExecution};
use tauri::State;
...
pub async fn ai_fix_error(
    ...
    let prompt = format!(
        "Fix this error: Command '{}' failed with: {}. Context: {}",
...
pub async fn create_terminal(
    ...
    let mut terminal_manager = state.terminal_manager.lock().await;
